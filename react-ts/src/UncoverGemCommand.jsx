...
import {BandungComponent,getPrefix,getSession} from "./Bandung" ;
	...
	extends BandungComponent
{
	...
	zoomin (announcementEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/announcement/view?sessionToken="+getSession().sessionToken+"&announcementEntityId="+announcementEntityId,null)
			.then(response=>{this.setState({command:"View",announcementEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/announcement/textlongdescription?sessionToken="+getSession().sessionToken+"&announcementEntityId="+announcementEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/announcement/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	render ()
	{
		...
		else if (this.state.command==="Signin"&&!getSession().sessionToken)
	...
	extends BandungComponent
{
	...
	zoomin (categoryEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/category/view?sessionToken="+getSession().sessionToken+"&categoryEntityId="+categoryEntityId,null)
			.then(response=>{this.setState({command:"View",categoryEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/category/textshortdescription?sessionToken="+getSession().sessionToken+"&categoryEntityId="+categoryEntityId,null)
			.then(response=>{this.setState({shortDescription:response.data})}) ;
		Axios.get(getPrefix()+"/app/category/textlongdescription?sessionToken="+getSession().sessionToken+"&categoryEntityId="+categoryEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/category/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/category/listbyparent?sessionToken="+getSession().sessionToken+"&page="+this.page+"&parentCategoryEntityId="+props.parentCategoryEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",categoryEntityList:response.data,categoryEntity:{}})}) ;
		else if (commandList==="ListUnpublished")
			Axios.get(getPrefix()+"/app/category/listunpublished?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=>{this.setState({command:"List",commandList:"List",categoryEntityList:response.data,categoryEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/category/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",categoryEntityList:response.data,categoryEntity:{}})}) ;
	...
	adminPermission ()
	{
		return (true||this.session.editor||this.session.administrator) ;
	}
	menu ()
	{
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="CategoryEntityShortDescription" name="shortDescription" className="text_area fields" placeholder="Enter shortDescription..." rows="4" cols="50" required></textarea>
	...
	renderUpdate ()
	{
		...
		return(
			<div className="update_div">
				...
				<textarea id="CategoryEntityShortDescription" name="shortDescription" className="text_area fields" defaultValue={this.state.shortDescription?this.state.shortDescription:""} rows="4" cols="50" required></textarea>
				<div className="editor_field fields"><Editor id="CategoryEntityLongDescription" name="longDescription" onEditorStateChange={(editorState)=>{this.longDescriptionEditorState = editorState}} wrapperClassName="wrapper-class" editorClassName="editor-class editor" toolbarClassName="toolbar-class toolbar" placeholder="Enter longDescription..."/></div>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
	...
	{
		Axios.get(getPrefix()+"/app/category/publish?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
	renderUnpublish ()
	{
	...
	{
		Axios.get(getPrefix()+"/app/category/unpublish?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
	renderSubscribe ()
	{
	...
	{
		Axios.get(getPrefix()+"/app/category/subscribe?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
	renderUnsubscribe ()
	{
	...
	{
		Axios.get(getPrefix()+"/app/category/unsubscribe?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
	renderRate ()
	{
	...
	executeRate (event)
	{
		Axios.get(getPrefix()+"/app/category/rate?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
	renderComment ()
	{
	...
	{
		Axios.get(getPrefix()+"/app/category/comment?sessionToken="+getSession().sessionToken+"&categoryEntityId="+this.state.categoryEntity.categoryEntityId,null)
			.then(response=>{this.zoomin(this.state.categoryEntity.categoryEntityId)}) ;
	}
}
	...
	extends BandungComponent
{
	...
	zoomin (categoryUserEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/categoryuser/view?sessionToken="+getSession().sessionToken+"&categoryUserEntityId="+categoryUserEntityId,null)
			.then(response=>{this.setState({command:"View",categoryUserEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/categoryuser/textlongdescription?sessionToken="+getSession().sessionToken+"&categoryUserEntityId="+categoryUserEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/categoryuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/categoryuser/listbycategory?sessionToken="+getSession().sessionToken+"&page="+this.page+"&categoryEntityId="+props.categoryEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",categoryUserEntityList:response.data,categoryUserEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/categoryuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",categoryUserEntityList:response.data,categoryUserEntity:{}})}) ;
	...
	extends BandungComponent
{
	...
	zoomin (contactEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/contact/view?sessionToken="+getSession().sessionToken+"&contactEntityId="+contactEntityId,null)
			.then(response=>{this.setState({command:"View",contactEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/contact/textlongdescription?sessionToken="+getSession().sessionToken+"&contactEntityId="+contactEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/contact/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/contact/listbyuser?sessionToken="+getSession().sessionToken+"&page="+this.page+"&userEntityId="+props.userEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",contactEntityList:response.data,contactEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/contact/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",contactEntityList:response.data,contactEntity:{}})}) ;
	...
	extends BandungComponent
{
	...
	zoomin (companyEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/company/view?sessionToken="+getSession().sessionToken+"&companyEntityId="+companyEntityId,null)
			.then(response=>{this.setState({command:"View",companyEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/company/textshortdescription?sessionToken="+getSession().sessionToken+"&companyEntityId="+companyEntityId,null)
			.then(response=>{this.setState({shortDescription:response.data})}) ;
		Axios.get(getPrefix()+"/app/company/textlongdescription?sessionToken="+getSession().sessionToken+"&companyEntityId="+companyEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/company/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/company/listunapproved?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=>{this.setState({command:"List",commandList:"List",companyEntityList:response.data,companyEntity:{}})}) ;
		else if (commandList==="ListByUser")
			Axios.get(getPrefix()+"/app/company/listbyuser?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=>{this.setState({command:"List",commandList:"List",companyEntityList:response.data,companyEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/company/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",companyEntityList:response.data,companyEntity:{}})}) ;
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="CompanyEntityShortDescription" name="shortDescription" className="text_area fields" placeholder="Enter shortDescription..." rows="4" cols="50" required></textarea>
	...
	renderUpdate ()
	{
		...
		return(
			<div className="update_div">
				...
				<textarea id="CompanyEntityShortDescription" name="shortDescription" className="text_area fields" defaultValue={this.state.shortDescription?this.state.shortDescription:""} rows="4" cols="50" required></textarea>
				<div className="editor_field fields"><Editor id="CompanyEntityLongDescription" name="longDescription" onEditorStateChange={(editorState)=>{this.longDescriptionEditorState = editorState}} wrapperClassName="wrapper-class" editorClassName="editor-class editor" toolbarClassName="toolbar-class toolbar" placeholder="Enter longDescription..."/></div>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
	...
	executeSubscribe (event)
	{
		Axios.get(getPrefix()+"/app/company/subscribe?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderUnsubscribe ()
	{
	...
	executeUnsubscribe (event)
	{
		Axios.get(getPrefix()+"/app/company/unsubscribe?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderRate ()
	{
	...
	executeRate (event)
	{
		Axios.get(getPrefix()+"/app/company/rate?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderComment ()
	{
	...
	executeComment (event)
	{
		Axios.get(getPrefix()+"/app/company/comment?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderAccept ()
	{
	...
	executeAccept (event)
	{
		Axios.get(getPrefix()+"/app/company/accept?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderDecline ()
	{
	...
	{
		Axios.get(getPrefix()+"/app/company/decline?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
	renderQuit ()
	{
	...
	executeQuit (event)
	{
		Axios.get(getPrefix()+"/app/company/quit?sessionToken="+getSession().sessionToken+"&companyEntityId="+this.state.companyEntity.companyEntityId,null)
			.then(response=>{this.zoomin(this.state.companyEntity.companyEntityId)}) ;
	}
}
	...
	extends BandungComponent
{
	...
	zoomin (companyUserEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/companyuser/view?sessionToken="+getSession().sessionToken+"&companyUserEntityId="+companyUserEntityId,null)
			.then(response=>{this.setState({command:"View",companyUserEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/companyuser/textlongdescription?sessionToken="+getSession().sessionToken+"&companyUserEntityId="+companyUserEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/companyuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/companyuser/listbycompany?sessionToken="+getSession().sessionToken+"&page="+this.page+"&companyEntityId="+props.companyEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",companyUserEntityList:response.data,companyUserEntity:{}})}) ;
		else if (commandList==="ListByLongDescription")
			Axios.get(getPrefix()+"/app/companyuser/listbylongdescription?sessionToken="+getSession().sessionToken+"&page="+this.page+"&companyEntityId="+props.companyEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",companyUserEntityList:response.data,companyUserEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/companyuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",companyUserEntityList:response.data,companyUserEntity:{}})}) ;
	...
	extends BandungComponent
{
	...
	zoomin (fontEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/font/view?sessionToken="+getSession().sessionToken+"&fontEntityId="+fontEntityId,null)
			.then(response=>{this.setState({command:"View",fontEntity:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/font/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	extends BandungComponent
{
	...
	zoomin (imageEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/image/view?sessionToken="+getSession().sessionToken+"&imageEntityId="+imageEntityId,null)
			.then(response=>{this.setState({command:"View",imageEntity:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/image/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	extends BandungComponent
{
	...
	zoomin (mainEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/main/view?sessionToken="+getSession().sessionToken+"&mainEntityId="+mainEntityId,null)
			.then(response=>{this.setState({command:"View",mainEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/main/textplainsignature?sessionToken="+getSession().sessionToken+"&mainEntityId="+mainEntityId,null)
			.then(response=>{this.setState({plainSignature:response.data})}) ;
		Axios.get(getPrefix()+"/app/main/texthtmlsignature?sessionToken="+getSession().sessionToken+"&mainEntityId="+mainEntityId,null)
			.then(response=>{this.setState({htmlSignature:response.data})}) ;
		Axios.get(getPrefix()+"/app/main/textheader?sessionToken="+getSession().sessionToken+"&mainEntityId="+mainEntityId,null)
			.then(response=>{this.setState({header:response.data})}) ;
		Axios.get(getPrefix()+"/app/main/textfooter?sessionToken="+getSession().sessionToken+"&mainEntityId="+mainEntityId,null)
			.then(response=>{this.setState({footer:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/main/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="MainEntityPlainSignature" name="plainSignature" className="text_area fields" placeholder="Enter plainSignature..." rows="4" cols="50" required></textarea>
				...
				<textarea id="MainEntityHeader" name="header" className="text_area fields" placeholder="Enter header..." rows="4" cols="50" required></textarea>
				<textarea id="MainEntityFooter" name="footer" className="text_area fields" placeholder="Enter footer..." rows="4" cols="50" required></textarea>
				<div className="button"><button className="create_button" type="submit">Create</button></div>
				</form>
			</div>
		) ;
	...
	renderUpdate ()
	{
		...
		return(
			<div className="update_div">
				...
				<textarea id="MainEntityPlainSignature" name="plainSignature" className="text_area fields" defaultValue={this.state.plainSignature?this.state.plainSignature:""} rows="4" cols="50" required></textarea>
				<div className="editor_field fields"><Editor id="MainEntityHtmlSignature" name="htmlSignature" onEditorStateChange={(editorState)=>{this.htmlSignatureEditorState = editorState}} wrapperClassName="wrapper-class" editorClassName="editor-class editor" toolbarClassName="toolbar-class toolbar" placeholder="Enter htmlSignature..."/></div>
				<textarea id="MainEntityHeader" name="header" className="text_area fields" defaultValue={this.state.header?this.state.header:""} rows="4" cols="50" required></textarea>
				<textarea id="MainEntityFooter" name="footer" className="text_area fields" defaultValue={this.state.footer?this.state.footer:""} rows="4" cols="50" required></textarea>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
		) ;
	...
	extends BandungComponent
{
	...
	zoomin (pageEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/page/view?sessionToken="+getSession().sessionToken+"&pageEntityId="+pageEntityId,null)
			.then(response=>{this.setState({command:"View",pageEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/page/textshortdescription?sessionToken="+getSession().sessionToken+"&pageEntityId="+pageEntityId,null)
			.then(response=>{this.setState({shortDescription:response.data})}) ;
		Axios.get(getPrefix()+"/app/page/textbody?sessionToken="+getSession().sessionToken+"&pageEntityId="+pageEntityId,null)
			.then(response=>{this.setState({body:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/page/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="PageEntityShortDescription" name="shortDescription" className="text_area fields" placeholder="Enter shortDescription..." rows="4" cols="50" required></textarea>
				<textarea id="PageEntityBody" name="body" className="text_area fields" placeholder="Enter body..." rows="4" cols="50" required></textarea>
				<div className="button"><button className="create_button" type="submit">Create</button></div>
				</form>
			</div>
		) ;
	...
	renderUpdate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="PageEntityShortDescription" name="shortDescription" className="text_area fields" defaultValue={this.state.shortDescription?this.state.shortDescription:""} rows="4" cols="50" required></textarea>
				<textarea id="PageEntityBody" name="body" className="text_area fields" defaultValue={this.state.body?this.state.body:""} rows="4" cols="50" required></textarea>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
		) ;
	...
	extends BandungComponent
{
	...
	zoomin (quizEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/quiz/view?sessionToken="+getSession().sessionToken+"&quizEntityId="+quizEntityId,null)
			.then(response=>{this.setState({command:"View",quizEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/quiz/textshortdescription?sessionToken="+getSession().sessionToken+"&quizEntityId="+quizEntityId,null)
			.then(response=>{this.setState({shortDescription:response.data})}) ;
		Axios.get(getPrefix()+"/app/quiz/textlongdescription?sessionToken="+getSession().sessionToken+"&quizEntityId="+quizEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/quiz/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/quiz/listbylabel?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=>{this.setState({command:"List",commandList:"List",quizEntityList:response.data,quizEntity:{}})}) ;
		else if (commandList==="ListByCategory")
			Axios.get(getPrefix()+"/app/quiz/listbycategory?sessionToken="+getSession().sessionToken+"&page="+this.page+"&categoryEntityId="+props.categoryEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",quizEntityList:response.data,quizEntity:{}})}) ;
		else if (commandList==="ListByCompany")
			Axios.get(getPrefix()+"/app/quiz/listbycompany?sessionToken="+getSession().sessionToken+"&page="+this.page+"&companyEntityId="+props.companyEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",quizEntityList:response.data,quizEntity:{}})}) ;
		else if (commandList==="ListUnpublished")
			Axios.get(getPrefix()+"/app/quiz/listunpublished?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=>{this.setState({command:"List",commandList:"List",quizEntityList:response.data,quizEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/quiz/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",quizEntityList:response.data,quizEntity:{}})}) ;
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="QuizEntityShortDescription" name="shortDescription" className="text_area fields" placeholder="Enter shortDescription..." rows="4" cols="50" required></textarea>
	...
	renderUpdate ()
	{
		...
		return(
			<div className="update_div">
				...
				<textarea id="QuizEntityShortDescription" name="shortDescription" className="text_area fields" defaultValue={this.state.shortDescription?this.state.shortDescription:""} rows="4" cols="50" required></textarea>
				<div className="editor_field fields"><Editor id="QuizEntityLongDescription" name="longDescription" onEditorStateChange={(editorState)=>{this.longDescriptionEditorState = editorState}} wrapperClassName="wrapper-class" editorClassName="editor-class editor" toolbarClassName="toolbar-class toolbar" placeholder="Enter longDescription..."/></div>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
	...
	executePublish (event)
	{
		Axios.get(getPrefix()+"/app/quiz/publish?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
	renderUnpublish ()
	{
	...
	executeUnpublish (event)
	{
		Axios.get(getPrefix()+"/app/quiz/unpublish?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
	renderSubscribe ()
	{
	...
	executeSubscribe (event)
	{
		Axios.get(getPrefix()+"/app/quiz/subscribe?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
	renderUnsubscribe ()
	{
	...
	executeUnsubscribe (event)
	{
		Axios.get(getPrefix()+"/app/quiz/unsubscribe?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
	renderRate ()
	{
	...
	executeRate (event)
	{
		Axios.get(getPrefix()+"/app/quiz/rate?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
	renderComment ()
	{
	...
	executeComment (event)
	{
		Axios.get(getPrefix()+"/app/quiz/comment?sessionToken="+getSession().sessionToken+"&quizEntityId="+this.state.quizEntity.quizEntityId,null)
			.then(response=>{this.zoomin(this.state.quizEntity.quizEntityId)}) ;
	}
}
	...
	extends BandungComponent
{
	...
	zoomin (quizUserEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/quizuser/view?sessionToken="+getSession().sessionToken+"&quizUserEntityId="+quizUserEntityId,null)
			.then(response=>{this.setState({command:"View",quizUserEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/quizuser/textlongdescription?sessionToken="+getSession().sessionToken+"&quizUserEntityId="+quizUserEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/quizuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
			...
			Axios.get(getPrefix()+"/app/quizuser/listbyquiz?sessionToken="+getSession().sessionToken+"&page="+this.page+"&quizEntityId="+props.quizEntityId,null)
				.then(response=>{this.setState({command:"List",commandList:"List",quizUserEntityList:response.data,quizUserEntity:{}})}) ;
		else
			Axios.get(getPrefix()+"/app/quizuser/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
				.then(response=> {this.setState({command:"List",commandList:"List",quizUserEntityList:response.data,quizUserEntity:{}})}) ;
	...
	extends BandungComponent
{
	...
	zoomin (scriptEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/script/view?sessionToken="+getSession().sessionToken+"&scriptEntityId="+scriptEntityId,null)
			.then(response=>{this.setState({command:"View",scriptEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/script/textbody?sessionToken="+getSession().sessionToken+"&scriptEntityId="+scriptEntityId,null)
			.then(response=>{this.setState({body:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/script/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="ScriptEntityBody" name="body" className="text_area fields" placeholder="Enter body..." rows="4" cols="50" required></textarea>
				<div className="button"><button className="create_button" type="submit">Create</button></div>
				</form>
			</div>
		) ;
	...
	renderUpdate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="ScriptEntityBody" name="body" className="text_area fields" defaultValue={this.state.body?this.state.body:""} rows="4" cols="50" required></textarea>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
		) ;
	...
	extends BandungComponent
{
	...
	zoomin (styleEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/style/view?sessionToken="+getSession().sessionToken+"&styleEntityId="+styleEntityId,null)
			.then(response=>{this.setState({command:"View",styleEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/style/textbody?sessionToken="+getSession().sessionToken+"&styleEntityId="+styleEntityId,null)
			.then(response=>{this.setState({body:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/style/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	renderCreate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="StyleEntityBody" name="body" className="text_area fields" placeholder="Enter body..." rows="4" cols="50" required></textarea>
				<div className="button"><button className="create_button" type="submit">Create</button></div>
				</form>
			</div>
		) ;
	...
	renderUpdate ()
	{
		return(
			<div className="update_div">
				...
				<textarea id="StyleEntityBody" name="body" className="text_area fields" defaultValue={this.state.body?this.state.body:""} rows="4" cols="50" required></textarea>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
		) ;
	...
	extends BandungComponent
{
	...
	zoomin (userEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/user/view?sessionToken="+getSession().sessionToken+"&userEntityId="+userEntityId,null)
			.then(response=>{this.setState({command:"View",userEntity:response.data})}) ;
		Axios.get(getPrefix()+"/app/user/textshortdescription?sessionToken="+getSession().sessionToken+"&userEntityId="+userEntityId,null)
			.then(response=>{this.setState({shortDescription:response.data})}) ;
		Axios.get(getPrefix()+"/app/user/textlongdescription?sessionToken="+getSession().sessionToken+"&userEntityId="+userEntityId,null)
			.then(response=>{this.setState({longDescription:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/user/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
	...
	renderUpdate ()
	{
		...
		return(
			<div className="update_div">
				...
				<textarea id="UserEntityShortDescription" name="shortDescription" className="text_area fields" defaultValue={this.state.shortDescription?this.state.shortDescription:""} rows="4" cols="50" required></textarea>
	...
	extends BandungComponent
{
	...
	zoomin (userEmailEntityId)
	{
		...
		Axios.get(getPrefix()+"/app/useremail/view?sessionToken="+getSession().sessionToken+"&userEmailEntityId="+userEmailEntityId,null)
			.then(response=>{this.setState({command:"View",userEmailEntity:response.data})}) ;
	}
	zoomout (commandList, props)
	{
		if (!commandList)
			Axios.get(getPrefix()+"/app/useremail/list?sessionToken="+getSession().sessionToken+"&page="+this.page,null)
		...
		if (this.state.userEmailEntity.userEmailEntityId)
			return (
				<div className="menu">
					<div>
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.zoomout(null)}}>List</button>}
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.command("ListByParent")}}>ListByParent</button>}
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.command("View")}}>View</button>}
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.command("Create")}}>Create</button>}
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.command("Update")}}>Update</button>}
						{(this.adminPermission())&&<button className="menu-action" onClick={()=>{this.command("Delete")}}>Delete</button>}
	...
	render ()
	{
		if (!this.state.command)
			...
			return this.renderList() ;
		else if (this.state.command==="ListByParent")
			return this.renderListByParent() ;
		else if (this.state.command==="View")
			return this.renderView() ;
		else if (this.state.command==="Create")
			return this.renderCreate() ;
	...
	executeListByParent (event)
	{
		Axios.get(getPrefix()+"/app/useremail/listbyparent?sessionToken="+getSession().sessionToken+"&userEmailEntityId="+this.state.userEmailEntity.userEmailEntityId,null)
			.then(response=>{this.zoomin(this.state.userEmailEntity.userEmailEntityId)}) ;
	}
	renderView ()
	{
		return(
	...
	renderUpdate ()
	{
		return(
			<div className="update_div">
				{this.menu()}
				<form onSubmit={(event)=>{this.executeUpdate(event)}}>
				<p><input id="UserEmailEntityEmail" name="email" className="input_field fields" type="text" defaultValue={this.state.userEmailEntity.email?this.state.userEmailEntity.email:""}/></p>
				<p><input id="UserEmailEntityValidationCode" name="validationCode" className="input_field fields" type="text" defaultValue={this.state.userEmailEntity.validationCode?this.state.userEmailEntity.validationCode:""}/></p>
				<p><input id="UserEmailEntityValidationDate" name="validationDate" className="input_field fields" type="text" defaultValue={this.state.userEmailEntity.validationDate?this.state.userEmailEntity.validationDate:""}/></p>
				<div className="button"><button className="update_button" type="submit">Update</button></div>
				</form>
			</div>
		) ;
	...
	executeUpdate (event)
	{
		...
		const form = new FormData() ;
		form.append('sessionToken',getSession().sessionToken) ;
		form.append('userEmailEntityId',this.state.userEmailEntity.userEmailEntityId) ;
		form.append('email',document.getElementById("UserEmailEntityEmail").value) ;
		form.append('validationCode',document.getElementById("UserEmailEntityValidationCode").value) ;
		form.append('validationDate',document.getElementById("UserEmailEntityValidationDate").value) ;
		Axios.post(getPrefix()+"/app/useremail/update",form).then(response=>{this.zoomin(response.data.userEmailEntityId)}) ;
	}
	renderDelete ()
	{
		return(
	...
	extends BandungComponent
{
	...
	executeview (event)
	{
		Axios.get(getPrefix()+"/app/session/view?sessionToken="+getSession().sessionToken,null) ;
	}
	renderConfirm ()
	{
	}
